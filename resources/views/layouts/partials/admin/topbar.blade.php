            ...
            <div class="navbar-brand">
                <a href="{{route('index')}}" class="logo">
                    ...
                    <b class="logo-icon">
                        ...
                        <!-- Light Logo icon -->
                        <img src="../../assets/images/logo-light-icon.png" alt="Logo" class="light-logo" />
                    </b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
                    <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="../../assets/images/logo-text.png" alt="Logo" class="dark-logo" />
                        <!-- Light Logo text -->
                                <img src="../../assets/images/logo-light-text.png" class="light-logo" alt="logo" />
                            </span>
                </a>
